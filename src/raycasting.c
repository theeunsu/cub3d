...
/*   Updated: 2024/10/25 17:45:14 by smiranda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void raycasting(t_game *game)
{
    ...
    {
        game->rays->flag = 0;
        h_vector = horizontal_intersection(game, set_angle(game->rays->ray_angle));
        v_vector = vertical_intersection(game, set_angle(game->rays->ray_angle));
